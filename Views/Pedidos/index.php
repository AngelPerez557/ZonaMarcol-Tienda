                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr class="venta-row"
                            ...
                            <td class="ps-4">
                                <span class="fw-bold" style="color:#F5A800;">#<?= str_pad($pedido['id'], 8, '0', STR_PAD_LEFT) ?></span>
                            ...
                            <td class="text-end fw-bold" style="color:#F5A800;">L. <?= number_format((float)$pedido['total'], 2) ?></td>
